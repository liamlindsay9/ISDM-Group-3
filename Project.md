...
- **Functionality Failure:** The system may be implemented with faulty or incorrect functionality. Faulty functionality could lead the system to mismatching Relationship Managers with customers, faulty potential buyer lists being created and given to Relationship managers. Depending on the importance of the functionality and the severity of the fault in its functionality, this could result in a mild nuisance to users of complete redundancy of the system.
